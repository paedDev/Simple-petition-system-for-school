...
const CitcsAdminDashboard = () => {
  ...
  // Fetch petitions and filter for "CITCS"
  const fetchPetitions = async () => {
    try {
      ...
      const filtered = res.data.filter(
        (petition) => petition.subject === "CITCS"
      );
  ...
  return (
    ...
    >
      <div className="header">
        <h1 className="title">CITCS Admin Dashboard</h1>
        <div>
...
export default CitcsAdminDashboard;
